...
def lookup_plant(plant_name: str) -> dict:
    ...
    return {
        ...
        "message": (
            ...
            "The database contains common houseplants such as pothos, snake plant, monstera, "
            "fiddle leaf fig, and others. Try a common name, scientific name, or alias. "
            "If the user asked about a plant not in the database, let them know and offer "
            "general care advice if possible."
        ),
    }
